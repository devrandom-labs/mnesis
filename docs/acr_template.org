...
#+DATE: <YYYY-MM-DD>
#+PROPERTY: ACR_ID MNESIS-ACR-[Sequential Number, e.g., 001]
...
* 4. Justification / Rationale
  ...
  ;; - How does it align with the overall architectural vision and principles of the project (e.g., `mnesis`'s philosophy of type safety, performance, purity)?
